...
val assignationStrategy = Strategy<AssignationNode> { services, node ->
  ...
  when {
    ...
    isAssignedConstant(modifier) -> throw AssignationException("Cannot assign to constant ${node.variable}.")
...
private fun isAssignedConstant(modifier: Modifier?) =
  modifier is Constant && modifier.value != null
